 ...
 * { com.stericsson.hardware.fm.FmTransmitter.OnForcedResetListener#onForcedReset(int)}.</li>
 * </ul>
 * </p>
...
public abstract class FmReceiver {
     ...
     * in idle.
     * <p/>
     * FmTransmitter#startAsync(FmBand)
     */
    ...
    public static boolean isApiSupported(Context context) {
        return context.getPackageManager().hasSystemFeature(
                PackageManagerMock.FEATURE_RADIO_FM_RECEIVER);
    }
     ...
     * {FmTransmitter#RESET_RX_IN_USE}.
     * </p>
     *
     * @param band the band to use
     * @throws IllegalArgumentException      if the band is null
     * @throws UnsupportedOperationException if the band is not supported by the hardware
     * @throws IllegalStateException         if it is called in an invalid state
     * @throws IOException                   if the FM hardware failed to start
     * @throws SecurityException             if the FM_RADIO_RECEIVER permission is not present
     * @see FmBand
     */
     ...
     *
     * @throws IllegalStateException if it is called in an invalid state
     * @throws IOException           if the FM hardware failed to resume
     * @throws SecurityException     if the FM_RADIO_RECEIVER permission is not present
     */
     ...
     *
     * @throws IllegalStateException if it is called in an invalid state
     * @throws IOException           if the FM hardware failed to pause
     * @throws SecurityException     if the FM_RADIO_RECEIVER permission is not present
     */
     ...
     *
     * @throws IOException       if the FM hardware failed to reset
     * @throws SecurityException if the FM_RADIO_RECEIVER permission is not present
     */
     ...
     * </p>
     *
     * @param threshold a value between 0-1000
     * @throws IllegalArgumentException if the value is not between 0-1000
     * @throws IllegalStateException    if it is called in an invalid state
     * @throws IOException              if the FM hardware failed to set threshold
     * @throws SecurityException        if the FM_RADIO_RECEIVER permission is not present
     */
     ...
     * @throws IllegalStateException if it is called in an invalid state
     * @throws IOException           if the FM hardware failed to get the threshold
     * @throws SecurityException     if the FM_RADIO_RECEIVER permission is not present
     */
     ...
     * @throws IllegalStateException if it is called in an invalid state
     * @throws IOException           if the FM hardware failed to get the frequency
     * @throws SecurityException     if the FM_RADIO_RECEIVER permission is not present
     */
     ...
     * @throws IOException       if the FM hardware failed to get the signal strength
     * @throws SecurityException if the FM_RADIO_RECEIVER permission is not present
     */
     ...
     *
     * @param forceMono if true, the hardware will only output mono audio. If false,
     ...
     *
     * @param automatic enable or disable automatic switching
     * @throws IllegalStateException if it is called in an invalid state
     * @throws SecurityException     if the FM_RADIO_RECEIVER permission is not present
     */
     ...
     * </p>
     *
     * @param frequency the frequency to tune to in kHz
     * @throws IllegalArgumentException if the frequency is not supported
     * @throws IllegalStateException    if it is called in an invalid state
     * @throws IOException              if the FM hardware failed to set frequency
     * @throws SecurityException        if the FM_RADIO_RECEIVER permission is not present
     * @see FmBand
     */
     ...
     * @param extras  extra parameters to the command
    ...
    public interface OnScanListener {
         ...
         * </p>
         *
         * @param frequency      the frequency in kHz where the channel was found
         * @param signalStrength the signal strength, 0-1000
         * @param aborted        true if the full scan was aborted, false otherwise
         */
         ...
         * <p/>
         *
         * @param tunedFrequency the current frequency in kHz of the tuner after the scan
         *                       operation was completed
         * @param signalStrength the signal strength, 0-1000
         * @param scanDirection  direction of scan, SCAN_DOWN or SCAN_UP
         * @param aborted        true if the scan was aborted, false otherwise
         */
    ...
    public interface OnRDSDataFoundListener {
         ...
         *
         * @param rdsData   the RDS data that was found
         * @param frequency the frequency where the RDS data was found
         */
    ...
    public interface OnPlayingInStereoListener {
         ...
         *
         * @param inStereo true if playback is in stereo, false if in mono
         */
    ...
    public interface OnForcedResetListener {
         ...
         *
         * @param reason reason why the FmReceiver reset:
         *               <ul>
    ...
    public interface OnStateChangedListener {
         ...
         *
         * @param oldState the old state of the FmReceiver
         * @param newState the new state of the FmReceiver
         */
    ...
    public interface OnExtraCommandListener {
         ...
         *
         * @param response the command the FmReceiver responds to
         * @param extras   extra parameters to the command
         */
    ...
    public interface OnAutomaticSwitchListener {
         ...
         * switch or TA event.
         *
         * @param newFrequency the frequency switched to
