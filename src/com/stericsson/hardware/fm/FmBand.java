...
public class FmBand implements Parcelable {
     ...
     *
     * @param minFrequency     the lowest frequency of the band in kHz
     * @param maxFrequency     the highest frequency of the band in kHz
     * @param channelOffset    the offset between the channels in the band in kHz
     * @param defaultFrequency the default frequency that the hardware will tune to at
     *                         startup
     * @throws IllegalArgumentException if the minFrequency is equal or higher then maxFrequency
     * @throws IllegalArgumentException if the defaultFrequency is not within the limits of
     *                                  minFrequency and maxFrequency
     * @throws IllegalArgumentException if the minFrequency or maxFrequency is not a multiplier of channelOffset
     */
     ...
     *
     * @param band one of {@link #BAND_US}, {@link #BAND_EU}, {@link #BAND_JAPAN}
     *             , {@link #BAND_CHINA}, {@link #BAND_EU_50K_OFFSET}
     * @throws IllegalArgumentException if the band is not one of {@link #BAND_US}, {@link #BAND_EU},
