...
public class FmReceiverService extends IFmReceiver.Stub {
    ...
    public static final String FM_RECEIVER_MANIFEST_PERM = "com.stericsson.permission.FM_RADIO_RECEIVER";
    ...
    public void start(FmBand band) {
        if (mContext.checkCallingOrSelfPermission(FM_RECEIVER_MANIFEST_PERM)
    ...
    public void addOnStateChangedListener(IOnStateChangedListener listener) {
        ...
        if (receiver == null) {
            ...
            try {
                ...
                MockSlog.e(TAG, "linkToDeath failed:", ex);
            }
        }
    }
